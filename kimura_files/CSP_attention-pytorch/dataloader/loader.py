...
class CityPersons(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.caffemodel:
            ...
            if self.type == 'train':
                ...
                y_center, y_height, y_offset = self.calc_gt_center(gts, igs, radius=2, stride=self.config.down, mode=self.type)
            ...
            if self.type == 'train' or 'val':
                ...
                return x_img, [y_center, y_height, y_offset], boxes
    ...
    def calc_gt_center(self, gts, igs, radius=2, stride=4, mode='train'):
